...
class CalibrationUiSourceTest {
    ...
    fun calibrationUiUsesDistanceInputAndDraggableVerticalCaliperLines() {
        ...
        assertTrue(mainActivity.contains("motionDetectorConfig = RecordedHfrMotionDetectorConfig()"))
        assertTrue(mainActivity.contains("RECORDED_HFR_MOTION_MIN_ESTIMATE_MPH"))
        assertTrue(mainActivity.contains("minimumSpeedGatePolicy = MinimumSpeedGatePolicy.SAME_PLANE_ONLY"))
