...
class CalibrationUiSourceTest {
    ...
    fun calibrationUiUsesDistanceInputAndDraggableVerticalCaliperLines() {
        ...
        assertTrue(app.contains("dismissedResultOverlayToken"))
        ...
        assertTrue(app.contains("background(Color(0x99207982)"))
        ...
        assertFalse(app.contains("align(Alignment.TopCenter)"))
        ...
        assertTrue(mainActivity.contains("Distance calibration required"))
        assertTrue(mainActivity.contains("Ball color required"))
        assertTrue(mainActivity.contains("Level required"))
        assertTrue(mainActivity.contains("playReadySignalThenVisualEstimate()"))
        assertTrue(mainActivity.contains("readySignalPending"))
        assertTrue(mainActivity.contains("startDirectVisualEstimate()"))
